...
<head>
    ...
    <meta name="author" content="KhnahDuy">
    <meta name="keywords"
...
<body class="BodyStyle">
        ...
        <section class="td-welcome">
            ...
            <div class="infos">
                <div class="logo-web-title">
                    <img class="logo-ws" src="https://i.imgur.com/dxVZLOG.png" alt="Lê Khánh Duy">
    ...
    <main id="td-main">
        ...
        <section class="td-content">
            <div class="about-me">
                ...
                <div class="avatar">
                    <img class="avatar-img" src="<?=$ThanhDieuHeader->avatar?>?v=<?=rand(1,999)?>" alt="Lê Khánh Duy">
    ...
    <footer id="footer">
        <span>
            <a href="//thanhdieu.com" target="_blank">&copy; Copyright&nbsp;KhanhDuy 2024</a>
        </span>
    </footer>
    <div class="time-now" id="real-time">00:00:00</div>
    <div id="Toast">kzi cuti không nè</div>
